...
public extension CV {
    static func createMihaelasProjects() -> [Project] {
        ...
        let seniorArchitect = Role(title: "Senior iOS Architect", seniority: .senior)

        // MARK: - Maurer Electronics

        let maurerIDSystems = try! Project.Builder()
            ...
            .addDescription("Remote from Zagreb, Croatia")
            .withTechs([swift, swiftUI, uiKit, swiftpm, structConcurrency, unittest])
            .build()
        result.append(maurerIDSystems)

        // MARK: - Independent

        let cupertino = try! Project.Builder()
            .withName("Cupertino")
            .withCompany(independent)
            .withRole(seniorArchitect)
            .withPeriod(start: (month: 11, year: 2025), end: (month: 4, year: 2026))
            ...
            .withTechs([swift, swiftpm, mcp, aiTooling])
            .build()
        result.append(cupertino)

        let irelay = try! Project.Builder()
            .withName("iRelay")
            .withCompany(independent)
            .withRole(seniorArchitect)
            .withPeriod(start: (month: 11, year: 2025), end: (month: 4, year: 2026))
        ...
        let everlivProject = try! Project.Builder()
            ...
            .withTechs([swift, swiftUI, rest, openapi, swiftpm, unittest, uitest, structConcurrency, sse, swiftServer])
            .build()
        ...
        let shopsavvy = try! Project.Builder()
            ...
            .withTechs([swift, uiKit, uiInCode, coreAnimation, rest, unittest, autoLayout, barcodes, swiftpm])
            .build()
